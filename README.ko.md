...
> 할당합니다. 현재 Billing Pricing API에는 **$0.005/시간** 유료 구간보다 먼저
> 월별 0원 주소시간 구간이 있습니다. 외부 IP 하나를 계속 사용하는 경우 대부분 또는
> 전부가 이 구간에 들어가지만, 결제 계정 전체에서 합산됩니다. 초과 주소시간, 추가
> 주소, outbound traffic, 세금이나 다른 resource 때문에 비용이 생길 수 있습니다. 적용 전
